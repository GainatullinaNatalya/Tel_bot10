...
bot = Bot("5666399861:AAEvMM48IkKI6Bi0V3RzyuwnwuCbgw9QRvE")
...
async def start_handler(message: types.Message):
    ...
    btn_echo = types.KeyboardButton('/echo')
    btns.add(btn_calc, btn_out, btn_image, btn_echo)
...
async def quit_handler(message: types.Message):
    await message.reply('I echo bot. Write me')
