...
let virtual-env = "C:\Red Tree\Учеба\GB\2 четверть\Python\Семинары\Tel_bot10\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Red Tree\Учеба\GB\2 четверть\Python\Семинары\Tel_bot10\venv\Scripts\deactivate.nu"
